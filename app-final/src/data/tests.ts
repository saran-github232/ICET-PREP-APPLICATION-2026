...
export const TESTS: TestMetadata[] = [
  ...
  { id: 'mock-ebook', title: '2026 Mock EBook', year: '2026', type: 'shift', pdfPath: '/PDF/2026 Mock EBook.pdf' },
  ...
  // Grand Tests (The 2 specified papers)
  { 
    id: 'grand-previous', 
    title: 'APICET Previous Year Solved (Complete)', 
    year: 'Historical', 
    type: 'grand', 
  ...
  { 
    id: 'grand-business', 
    title: 'Business & Computer Terminology Mock', 
    year: '2026', 
    type: 'grand', 
